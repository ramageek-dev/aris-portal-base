 ...
 * Bugfix by gabri.ns@gmail.com
 * allocate function do not immedietly allocate color
 * it search at pallete first weather there is exist index with the same color
 */
class FColor {
	...
	public function allocate($im) {
      $return = imagecolorexact($im,$this->r,$this->g,$this->b);
